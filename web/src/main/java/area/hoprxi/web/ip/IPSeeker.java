 ...
 */
package area.hoprxi.web.ip;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import mi.hoprxi.util.UrlHelper;
...
public class IPSeeker {
    ...
    private static final String IP_FILE = "cc.foxtail.area.web.ip.qqwry.dat";
    // 一些固定常量，比如记录长度等等
    ...
    private IPSeeker() {
        ...
        b3 = new byte[3];
        try {
            File file = new File(UrlHelper.toUrl(UrlHelper.toUniversalFilePath(IP_FILE)).toURI());
