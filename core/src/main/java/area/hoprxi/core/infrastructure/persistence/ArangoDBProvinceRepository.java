...
import area.hoprxi.core.domain.model.Province;
import area.hoprxi.core.domain.model.ProvinceRepository;
 ...
 */
public class ArangoDBProvinceRepository implements ProvinceRepository {
    ...
    public Province find(String id) {
        ...
        if (exists) {
            final String query = "WITH country,province,wgs84\n" +
                    ...
                    "RETURN {'id':p._key,'parentId':c._key,'name':p.name,'postcode':p.postcode,'sequence':p.sequence,'wgs84':w}";
