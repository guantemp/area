...
public class Province extends Area {
    ...
    public Province(String id, String parentId, Name name, String postcode, byte sequence, WGS84 wgs84) {
    ...
    protected void setParentId(String parentId) {
        ...
        Matcher matcher = PROVINCE_PARENT_PATTERN.matcher(parentId);
        if (!matcher.matches())
    ...
    protected void setId(String id) {
        ...
        Matcher matcher = PROVINCE_PATTERN.matcher(id);
        if (!matcher.matches())
            throw new IllegalArgumentException("");
        this.id = id;
    }
