...
public class City extends Area {
    ...
    public City(String id, String parentId, Name name, String postcode, byte sequence, WGS84 wgs84) {
    ...
    protected void setParentId(String parentId) {
        ...
        Matcher matcher = CITY_PATTERN.matcher(parentId);
        if (!matcher.matches())
    ...
    protected void setId(String id) {
        ...
        Matcher matcher = CITY_PATTERN.matcher(id);
        if (!matcher.matches())
            throw new IllegalArgumentException("");
        this.id = id;
    }
