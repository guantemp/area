...
public class County extends Area {
    ...
    public County(String id, String parentId, Name name, String postcode, byte sequence, WGS84 wgs84) {
    ...
    protected void setParentId(String parentId) {
        ...
        Matcher matcher = COUNTY_PATTERN.matcher(parentId);
        if (!matcher.matches())
    ...
    protected void setId(String id) {
        ...
        Matcher matcher = COUNTY_PATTERN.matcher(id);
        if (!matcher.matches())
            throw new IllegalArgumentException("");
        this.id = id;
    }
