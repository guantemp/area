...
public class County extends Area {
    ...
    public County(String code, String parentCode, Name name, Boundary boundary) {
        super(code, parentCode, name, boundary);
    }

    public County(String code, String parentCode, Name name, Boundary boundary, String postcode, String telephoneCode) {
